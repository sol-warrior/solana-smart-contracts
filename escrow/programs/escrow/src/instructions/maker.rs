...
pub struct Maker<'info> {
    ...
    pub mint_n: InterfaceAccount<'info, Mint>,
...
impl<'info> Maker<'info> {
    ...
    fn populate_escrow(&mut self, seed: u64, amount: u64, bump: u8) -> Result<()> {
        self.escrow.set_inner(Escrow {
            ...
            // token_mint_m_offered:amount
            token_mint_n_expected: amount,
            bump,
        });
...
pub fn handler(ctx: Context<Maker>, seed: u64, receive: u64, amount: u64) -> Result<()> {
    // Validate the amount
